...
export class DataService {
  ...
  deleteToken(): void {
    this.cookieService.delete('token'); // Correctly remove the token from cookies
    console.log('Token deleted successfully'); // Confirmation message
  }
  addDoctor(doctorData: any): Observable<any> {
    return this.http.post<any>('YOUR_API_ENDPOINT_HERE', doctorData);
  }
}
